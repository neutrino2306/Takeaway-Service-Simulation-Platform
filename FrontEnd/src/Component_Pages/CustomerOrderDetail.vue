...
import { findItemByItemID, findLineItemByOrderID } from '@/network/api';
...
<template>
  ...
  <div class="pt-28 px-6 w-full">
    <!-- 第一行：订单ID、时间、状态 -->
    <div class="flex flex-nowrap justify-start items-center text-xl mb-4" style="gap: 150px;"> <!-- 增加字段间的间距 -->
  ...
  <div class="bg-white bg-opacity-90 shadow-md fixed w-full flex bottom-0 left-0 z-10 h-16 py-1 px-6">
    ...
    <button class="ml-auto mr-32 bg-blue-300 hover:bg-blue-400 text-white font-bold h-8 px-8 rounded-2xl mt-3" @click="navigateToCustomerOrders">返回</button>
  </div>
</template>
